...
public class UnityObjectBehaviour : MonoBehaviour
{
	...
	{
		this.UnityObject.u.FireOnDisconnectedFromServer(info);
	}
	...
	{
		this.UnityObject.u.FireOnFailedToConnect(error);
	}
	public void OnFailedToConnectToMasterServer(NetworkConnectionError error)
	{
		this.UnityObject.u.FireOnFailedToConnectToMasterServer(error);
	}
	public void OnGUI()
	{
	...
	{
		this.UnityObject.u.FireOnMasterServerEvent(msEvent);
	}
	...
	{
		this.UnityObject.u.FireOnNetworkInstantiate(info);
	}
	...
	{
		this.UnityObject.u.FireOnPlayerConnected(player);
	}
	public void OnPlayerDisconnected(NetworkPlayer player)
	{
		this.UnityObject.u.FireOnPlayerDisconnected(player);
	}
	...
	{
		this.UnityObject.u.FireOnSerializeNetworkView(stream, info);
	}
