...
namespace uSquid
{
	public class MonoBehaviourMessages
	{
		...
		public event OnDisconnectedFromServerEventArgs OnDisconnectedFromServer;
		...
		public event OnFailedToConnectEventArgs OnFailedToConnect;
		public event OnFailedToConnectToMasterServerEventArgs OnFailedToConnectToMasterServer;
		...
		public event OnMasterServerEventEventArgs OnMasterServerEvent;
		...
		public event OnNetworkInstantiateEventArgs OnNetworkInstantiate;
		public event OnParticleCollisionEventArgs OnParticleCollision;
		public event OnPlayerConnectedEventArgs OnPlayerConnected;
		public event OnPlayerDisconnectedEventArgs OnPlayerDisconnected;
		...
		public event OnSerializeNetworkViewEventArgs OnSerializeNetworkView;
		...
		public delegate void OnDisconnectedFromServerEventArgs(UnityObject uObj, NetworkDisconnection info);
		public delegate void OnFailedToConnectEventArgs(UnityObject uObj, NetworkConnectionError error);
		public delegate void OnFailedToConnectToMasterServerEventArgs(UnityObject uObj, NetworkConnectionError error);
		...
		public delegate void OnMasterServerEventEventArgs(UnityObject uObj, MasterServerEvent msEvent);
		public delegate void OnNetworkInstantiateEventArgs(UnityObject uObj, NetworkMessageInfo info);
		public delegate void OnParticleCollisionEventArgs(UnityObject uObj, GameObject other);
		public delegate void OnPlayerConnectedEventArgs(UnityObject uObj, NetworkPlayer player);
		public delegate void OnPlayerDisconnectedEventArgs(UnityObject uObj, NetworkPlayer player);
		public delegate void OnRenderImageEventArgs(UnityObject uObj, RenderTexture src, RenderTexture dest);
		public delegate void OnSerializeNetworkViewEventArgs(UnityObject uObj, BitStream stream, NetworkMessageInfo info);
		...
		[SuppressMessage("Microsoft.Design", "CA1030:UseEventsWhereAppropriate", Justification = "Firing events is the appropriate usage of \"Fire\"")]
		public void FireOnDisconnectedFromServer(NetworkDisconnection info)
		{
			if (OnDisconnectedFromServer != null)
			{
				OnDisconnectedFromServer(UnityObject, info);
			}
		}
		public void ClearOnDisconnectedFromServer()
		{
		...
		[SuppressMessage("Microsoft.Design", "CA1030:UseEventsWhereAppropriate", Justification = "Firing events is the appropriate usage of \"Fire\"")]
		public void FireOnFailedToConnect(NetworkConnectionError error)
		{
			if (OnFailedToConnect != null)
			{
				OnFailedToConnect(UnityObject, error);
			}
		}
		public void ClearOnFailedToConnect()
		{
			OnFailedToConnect = null;
		}
		[SuppressMessage("Microsoft.Design", "CA1030:UseEventsWhereAppropriate", Justification = "Firing events is the appropriate usage of \"Fire\"")]
		public void FireOnFailedToConnectToMasterServer(NetworkConnectionError error)
		{
			if (OnFailedToConnectToMasterServer != null)
			{
				OnFailedToConnectToMasterServer(UnityObject, error);
			}
		}
		public void ClearOnFailedToConnectToMasterServer()
		{
			OnFailedToConnectToMasterServer = null;
		}
		[SuppressMessage("Microsoft.Design", "CA1030:UseEventsWhereAppropriate", Justification = "Firing events is the appropriate usage of \"Fire\"")]
		...
		[SuppressMessage("Microsoft.Design", "CA1030:UseEventsWhereAppropriate", Justification = "Firing events is the appropriate usage of \"Fire\"")]
		public void FireOnMasterServerEvent(MasterServerEvent msEvent)
		{
			if (OnMasterServerEvent != null)
			{
				OnMasterServerEvent(UnityObject, msEvent);
			}
		}
		public void ClearOnMasterServerEvent()
		{
			OnMasterServerEvent = null;
		}
		[SuppressMessage("Microsoft.Design", "CA1030:UseEventsWhereAppropriate", Justification = "Firing events is the appropriate usage of \"Fire\"")]
		...
		[SuppressMessage("Microsoft.Design", "CA1030:UseEventsWhereAppropriate", Justification = "Firing events is the appropriate usage of \"Fire\"")]
		public void FireOnNetworkInstantiate(NetworkMessageInfo info)
		{
			if (OnNetworkInstantiate != null)
			{
				OnNetworkInstantiate(UnityObject, info);
			}
		}
		public void ClearOnNetworkInstantiate()
		{
			OnNetworkInstantiate = null;
		}
		[SuppressMessage("Microsoft.Design", "CA1030:UseEventsWhereAppropriate", Justification = "Firing events is the appropriate usage of \"Fire\"")]
		...
		[SuppressMessage("Microsoft.Design", "CA1030:UseEventsWhereAppropriate", Justification = "Firing events is the appropriate usage of \"Fire\"")]
		public void FireOnPlayerConnected(NetworkPlayer player)
		{
			if (OnPlayerConnected != null)
			{
				OnPlayerConnected(UnityObject, player);
			}
		}
		...
		[SuppressMessage("Microsoft.Design", "CA1030:UseEventsWhereAppropriate", Justification = "Firing events is the appropriate usage of \"Fire\"")]
		public void FireOnPlayerDisconnected(NetworkPlayer player)
		{
			if (OnPlayerDisconnected != null)
			{
				OnPlayerDisconnected(UnityObject, player);
			}
		}
		...
		public void ClearOnSerializeNetworkView()
		{
			OnSerializeNetworkView = null;
		}
		[SuppressMessage("Microsoft.Design", "CA1030:UseEventsWhereAppropriate", Justification = "Firing events is the appropriate usage of \"Fire\"")]
